...
public class SaveData : MonoBehaviour
{
    ...
    void Start()
    {
        headSet = Utils.getHeadset(VRRig.Instance.vRType).transform;
        leftController = Utils.getLeftController(VRRig.Instance.vRType).transform;
        rightController = Utils.getRightController(VRRig.Instance.vRType).transform;
