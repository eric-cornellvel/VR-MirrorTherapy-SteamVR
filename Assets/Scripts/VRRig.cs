...
public class VRRig : MonoBehaviour
{
    ...
    public Utils.VRType vRType = Utils.VRType.Oculus;
    ...
    public void changeMirror(MirrorMode mode)
    {
        ...
        {
            leftHandIKSolver.vrTarget = Utils.getLeftController(vRType).transform;
            leftHandIKSolver.rigTarget = Utils.getLeftController(vRType).transform.Find("LeftHandIKTarget");

            rightHandIKSolver.vrTarget = Utils.getRightController(vRType).transform;
            rightHandIKSolver.rigTarget = Utils.getRightController(vRType).transform.Find("RightHandIKTarget");
        ...
        else if (mode == MirrorMode.MirrorLeft) //mirror left
        {
            ...
            if (vRType == Utils.VRType.Oculus)
            {
                rightHandIKSolver.vrTarget = Utils.getCameraRig(vRType).transform.Find("TrackingSpace/MirrorLeft");
                rightHandIKSolver.rigTarget = Utils.getCameraRig(vRType).transform.Find("TrackingSpace/MirrorLeft/MirrorLeftIKTarget");
            }
            else if(vRType == Utils.VRType.SteamVR)
            {
                rightHandIKSolver.vrTarget = Utils.getCameraRig(vRType).transform.Find("Camera Offset/MirrorLeft");
                rightHandIKSolver.rigTarget = Utils.getCameraRig(vRType).transform.Find("Camera Offset/MirrorLeft/MirrorLeftIKTarget");
            }
        }
        else if(mode == MirrorMode.MirrorRight) // mirror right
        {
            ...
            if (vRType == Utils.VRType.Oculus)
            {
                leftHandIKSolver.vrTarget = Utils.getCameraRig(vRType).transform.Find("TrackingSpace/MirrorRight");
                leftHandIKSolver.rigTarget = Utils.getCameraRig(vRType).transform.Find("TrackingSpace/MirrorRight/MirrorRightIKTarget");
            }
            else if (vRType == Utils.VRType.SteamVR)
            {
                leftHandIKSolver.vrTarget = Utils.getCameraRig(vRType).transform.Find("Camera Offset/MirrorRight");
                leftHandIKSolver.rigTarget = Utils.getCameraRig(vRType).transform.Find("Camera Offset/MirrorRight/MirrorRightIKTarget");
            }
    ...
    public void Calibration()
    {
        ...
        {
            InputManager_SteamVR.Instance.HideControlelr();
        }
    ...
    void Start()
    {
        ...
        cameraRig = Utils.getCameraRig(vRType);
        Debug.Log("testing: " + Utils.getLeftController(vRType).name);
