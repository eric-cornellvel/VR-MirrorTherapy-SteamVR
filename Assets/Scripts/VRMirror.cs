...
public class VRMirror : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            playerTransform = VRRig.Instance.femaleAvatar.transform.FindDeepChild("mixamorig:Hips");
        }
        else if (VRRig.Instance.avatarGender == VRRig.AvatarGender.Male)
        {
            playerTransform = VRRig.Instance.maleAvatar.transform.FindDeepChild("mixamorig:Hips");
        }
